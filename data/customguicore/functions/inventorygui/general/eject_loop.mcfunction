...
## Eject
    execute if score $Slot.Block Temporary = $Slot.BlockGUI Temporary unless score $isSlot Temporary matches 1 run function customguicore:blockgui/general/eject
