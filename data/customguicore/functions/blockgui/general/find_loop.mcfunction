...
## Push Back
    execute if score $Slot.Block Temporary = $Slot.BlockGUI Temporary run data modify storage customguicore: Callback.BlockGUI.ChangedItems append from storage customguicore: Temp.Clone.Block.Items[0]
