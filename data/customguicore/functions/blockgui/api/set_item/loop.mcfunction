...
# ## $Item.Slot > $Consume.Slot
#     execute if score $Item.Slot Temporary > $SetItem.Slot Temporary run data modify storage customguicore: Temp.RestoreItems append value {Slot:-1b,Count:0b,id:"air"}
